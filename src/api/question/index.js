...
const { id, alias, text, type, required,items, hasComment, commentIsRequired, commentLabel, tag } = schema.tree
 ...
 */
router.post('/',
  body({ id, alias, text, type, required, items, hasComment, commentIsRequired, commentLabel, tag }),
  create)
