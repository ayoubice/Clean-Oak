...
const { id, alias, text, type, required,items, hasComment, commentIsRequired, commentLabel, tags } = schema.tree
 ...
 */
router.post('/',
  body({ id, alias, text, type, required, items, hasComment, commentIsRequired, commentLabel, tags }),
  create)
